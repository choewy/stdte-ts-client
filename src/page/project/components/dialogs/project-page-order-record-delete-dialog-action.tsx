...
export const ProjectPageOrderRecordDeleteDialogAction: FunctionComponent<{
  row: ProjectRecordRow;
  onClose: () => void;
}> = ({ row, onClose }) => {
  const callback = projectRecordHook.useDeleteCallback(ProjectRecordType.Order, row.id);
