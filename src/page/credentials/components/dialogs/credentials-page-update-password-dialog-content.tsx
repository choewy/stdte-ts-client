...
export const CredentialsPageUpdatePasswordDialogContent: FunctionComponent<{ id: number }> = ({ id }) => {
  ...
  const closeDialog = dialogHook.useCredentialsPageUpdatePasswordDialogCallback(id, false);
